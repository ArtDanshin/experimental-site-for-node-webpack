  ...
  const featuredArticles = [
    {
      ...
      excerpt: 'Разбираем основные техники оптимизации React компонентов и приложений для улучшения производительности.',
    ...
    },
    {
      ...
      slug: 'gaming-rig',
      excerpt: 'Как выбрать компоненты для ПК, который подойдет как для игр, так и для разработки.',
      content: 'Полное содержание статьи...',
